...
const makeStyles = (t: SemanticTokens) => StyleSheet.create({
  ...
  dateLabel: { fontWeight: '600', color: t.textSecondary, marginBottom: 4, marginTop: 4 },
  sectionLabel: { fontWeight: '600', color: t.textSecondary, marginBottom: 8, marginTop: 16 },
